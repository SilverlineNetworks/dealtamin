            ...
            <nav class="d-none d-md-block py-0 navbar navbar-expand-lg">
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav categories_main_menu mr-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ url('/about-us') }}">@lang('menu.aboutus')</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="{{ url('/all/services') }}">@lang('menu.allservices')</a>
                        </li>
                        <li class="nav-item">
                    ...
                    <ul class="nav navbar-right">
                      ...
                      <!--<a class="nav-link align-items-center d-flex" href="{{ route('front.cartPage') }}"><i class="zmdi zmdi-ticket-star"></i>@lang('front.cart')</a><span class="cart-badge cart-badge">{{ $productsCount }}</span>-->
                      </li>
                  </ul>
                </div>
            </nav>
                        ...
                        <ul class="mobile_menu">
                            <li>
                              <a href="{{ route('front.index') }}" class="navLogo">
                                <img src="{{ $frontThemeSettings->logo_url }}" alt="Logo" width="auto" />
                              </a>
                            </li>
                            ...
                            <li><a href="{{ url('/about-us') }}">@lang('menu.aboutus')</a></li>
                            <li> <a href="{{ url('/all/services') }}">@lang('menu.allservices')</a></li>
                        ...
                        // CATEGORIES START
                            @if (array_search('Category Section', array_column($sections, 'name')) !== false)
                                if(response.categories.length>0)
                                {
                                    let categories = `
                                    <div class="container">
                                        <div class="sec-title light centred"> <p>@lang('front.chooseYourCategoryHead')</p> <h2>@lang('front.chooseYourCategory')</h2> </div>
                                        <div class="row">`;
                                    ...
                                    if (category.services.length > 0)
                                    {
                                        ...
                                        <div class="categoryBox">
                                            <a href="`+category.slug+`/services">
                                                <img src="`+category.category_image_url+`" class="img-fluid" alt="Cafes" />
                        ...
                        // SPOTLIGHT START
                            ...
                            if(response.spotlight.length>0)
                            {
                                ...
                                for (var i=0; i<slider_length; i++) {
                                    $("#spotlight_slider").trigger('remove.owl.carousel').trigger('refresh.owl.carousel');
                                }
                                ...
                                <p class="px-4">@lang('app.starting') @lang('app.from'):&nbsp;<span class="spotlightPrice">{{ $settings->currency->currency_symbol }}${spotlight.deal.deal_amount} </span>
                                    <br><span class="spotlightName">${spotlight.company.company_name}</span></p>
                                    <div class="d-flex px-2">
                                        <div class="col-md-6 spot_deal pt-2">
                                            <a
                                                ...
                                                data-price="${parseFloat(spotlight.deal.deal_amount).toFixed(2)}"
                                        ...
                                        <div class="media">
                                            <div class="featured_deal_imgBox">
                                                <a href="${deal.deal_detail_url}">
                                                    <img src="${deal.deal_image_url}" alt="Deal1">
                                                </a>
                                            </div>
                                            <div class="media-body featuredDealDetail position-relative ">
                                                <span class="tag">${deal_type}</span>
                                                <h2 class="mb-0">${deal.company.company_name}</h2>
                                                <h1>${deal.title}</h1>
                                                <p class="mb-lg-1 mb-xl-3">{{ $settings->currency->currency_symbol }}${parseFloat(deal.deal_amount).toFixed(2)} &nbsp;&nbsp;<span>{{ $settings->currency->currency_symbol }}${parseFloat(deal.original_amount).toFixed(2)}</span></p>
                                                <a
                                                    href="${deal.deal_detail_url}"
                                                    class="btn w-100 add-to-cart"
                                                    data-type="deal"
                                                    data-unique-id="deal${deal.id}"
                                                    data-id="${deal.id}"
                                                    data-price="${parseFloat(deal.deal_amount).toFixed(2)}"
