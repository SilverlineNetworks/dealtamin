        ...
        <div class="container">
            <div class="row">
                <div class="col-md-3 col-6">
                    ...
                    <p class="footer-text">Dealtamin is a super specialty healthcare portal providing exceptional patient care across all communities. In view of the current challenging times, you can now avail our services from home.</p>
                ...
                <div class="col-md-3 col-6">
                    ...
                    <ul class="px-0 mb-0 mt-4">
                        ...
                        <li><a href="{{ route('front.search', ['c' => $store->id, 'term' => $store->company_name]) }}"><span></span>{{ ucwords($store->company_name) }} </a></li>
                        @endforeach
                    </ul>
                </div>
