        ...
        <div class="col-md-6 mobile-no-padding">
            <div class="card single_deal_box border-0">
                <div class="card-image position-relative">
                    ...
                    <img class="card-img-top" src="{{ $deal->deal_image_url }}" alt="Card image"></a>
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">
                        <span class="deal_card_current_price">{{ $settings->currency->currency_symbol }}{{ $deal->deal_amount }}</span>
                        @if($deal->percentage > 0)
                        <span class="deal_card_old_price">{{ $settings->currency->currency_symbol }}{{ $deal->original_amount }}</span>|
                        @else &nbsp;&nbsp;|
                        @endif
