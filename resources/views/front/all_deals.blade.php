            ...
            $.easyAjax({
                ...
                success: function (response) {
                    ...
                    else
                    {
                        ...
                        $('#filtered_deals').html('<div class="mt-4 no_result text-center noResultFound"><img src="'+image_path+'" class="mx-auto d-block" alt="Image" width="40%" /><h2 class="mt-3">@lang("messages.noResultFound") :(</h2><p>@lang("messages.checkSpellingOrUseGeneralTerms")</p></div>');
                    }
