                ...
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <select name="business_type" id="businessType" class="form-control select2">
                            <option value="individual">@lang('modules.paymentCredential.activationForm.individual')</option>
                            <option value="partnership">@lang('modules.paymentCredential.activationForm.partnership')</option>
                            <option value="proprietorship">@lang('modules.paymentCredential.activationForm.proprietorship')</option>
                            <option value="public_limited">@lang('modules.paymentCredential.activationForm.publicLimited')</option>
                            <option value="private_limited">@lang('modules.paymentCredential.activationForm.privateLimited')</option>
                            ...
                            <option value="educational_institutes">@lang('modules.paymentCredential.activationForm.educationalInstitutes')</option>
                            ...
                            <option value="not_yet_registered">@lang('modules.paymentCredential.activationForm.notYetRegistered')</option>
            ...
            <div class="col-md-12">
                <div class="form-group">
                    <button id="save-form" type="button" class="btn btn-success">
                        <i class="fa fa-check"></i> @lang('app.submit')
                    </button>
                </div>
            </div>
        ...
        $.easyAjax({
            ...
            success: function (response) {
                ...
                if (response.status == 'fail') {
                    $('#'+response.error_name).closest('.form-group').append('<div class="invalid-feedback">' + response.message + '</div>')
                    $('#'+response.error_name).closest('.form-group').find('.form-control').addClass("is-invalid")
                }
            }
        })
    })
