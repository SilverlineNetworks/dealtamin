    ...
    <div class="col-md-12">
        <div class="card card-dark">
            <div class="card-header">
                <div class="card-header">
                    @if ($user->is_employee)
                        <h3 class="card-title">@lang('app.applyLeave')</h3>
                    @else
                        <h3 class="card-title">@lang('app.assignLeave')</h3>
                    @endif
                </div>
            </div>
            ...
            <div class="modal-footer">
                ...
                <button type="button" id="save-form" class="btn btn-primary btn-light-round">
...
<script>
    ...
    $('#createLeaveForm').on('click', '#save-form', function() {
