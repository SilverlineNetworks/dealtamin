                ...
                <div class="card-body">
                    <form role="form" id="createForm"  class="ajax-form" method="POST">
                        ...
                        <div class="row">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="services[]" id="services" class="form-control form-control-lg select2" multiple="multiple">
                                        ...
                                        @foreach($services as $service)
                                            <option value="{{ $service->id }}">{{ $service->name.' ('.$service->location->name.')' }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="row deal-form d-none">
                            <div class="col-md-3">
                                <div class="form-group">
                                        ...
                                        <div class="form-group" id="day-div">
                                            <label>
                                                <div class="icheckbox_flat-green" aria-checked="false" aria-disabled="false" id="icheckbox_flat">
                                                    <input type="checkbox" checked value="{{$day}}" name="days[]" class="flat-red columnCheck"  id= "columnCheck">
