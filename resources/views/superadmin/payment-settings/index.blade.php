...
@section('content')
    ...
    <div class="row">
        <div class="col-12 col-md-2 mb-4 mt-3 mb-md-0 mt-md-0">
            ...
            <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist"
                ...
                <a class="nav-link active" href="#online" data-toggle="tab">@lang('app.paymentCredential') @lang('menu.settings')</a>
                                    ...
                                    <div class="col-md-12 ">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                class="toggle-stripe" data-div-id="stripe-credentials"
                                            ...
                                            <div id="stripe_commision_section" class="col-md-6 float-right @if($credentialSetting->stripe_status == 'deactive') d-none @endif">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <br>
                                                        <label class="switch">
                                                        <input type="checkbox" name="stripe_commission_status" id="stripe_commission_status"
                                                        @if($credentialSetting->stripe_status == 'active' && $credentialSetting->stripe_commission_status == 'active')
                                                        checked
                                                        @endif value="active" data-element-id="stripe-commission-credentials" class="commission_status">
                                                        <span class="slider round"></span>
                                                        </label>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="form-group @if($credentialSetting->stripe_status == 'deactive' && $credentialSetting->stripe_commission_status == 'deactive') d-none @endif" id="stripe-commission-credentials">
                                                        <label
                                                        class="control-label">@lang('app.commission') @lang('app.percentage')</label>
                                                        <input type="number" onkeypress="return isNumberKey(event)" class="form-control form-control-lg"
                                                        id="stripeCommmissionAmt" name="stripeCommmissionAmt" value="{{$credentialSetting->stripe_commission_percentage}}" min="0">
                                                    </div>
                                                </div>
                                            </div>
                                            </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group d-flex flex-column">
                                                ...
                                                <div class="d-flex">
                                                    ...
                                                    class="toggle-razorpay" data-div-id="razorpay-credentials"
                                                    ...
                                                    @lang('modules.paymentCredential.changeCurrencyToINR')(<a href="{{ route('superadmin.settings.index').'#general' }}">@lang('menu.general')</a>)
                                                    </span>
                                                </div>
                                            </div>
                                            </div>
                                            <div id="razorpay_commision_section" class="col-md-6 float-right @if($credentialSetting->razorpay_status == 'deactive') d-none @endif">
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <h5 class="text-success">@lang('app.add') @lang('app.commission')</h5>
                                                    <div class="form-group">
                                                        <label class="control-label">
                                                        @lang("modules.commission.status")
                                                        </label>
                                                        <br>
                                                        <label class="switch">
                                                        <input type="checkbox" name="razorpay_commission_status"
                                                        id="razorpay_commission_status"
                                                        @if($credentialSetting->razorpay_commission_status == 'active')
                                                        checked
                                                        @endif value="active"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group @if($credentialSetting->razorpay_status == 'deactive' && $credentialSetting->razorpay_commission_status == 'deactive') d-none @endif" id="razorpay-commission-credentials">
                                                        <label
                                                        class="control-label">@lang('app.commission') @lang('app.percentage')</label>
                                                        <input type="number" onkeypress="return isNumberKey(event)" class="form-control form-control-lg"
                                                        id="razorCommmissionAmt" name="razorCommmissionAmt" value="{{$credentialSetting->razorpay_commission_percentage}}" min="0">
                                                    </div>
                                                </div>
                                            </div>
                                            </div>
    ...
    {{--coupon detail Modal--}}
    <div class="modal fade bs-modal-lg in" id="captcha-detail-modal" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
...
@push('footer-js')
    <script>
        $(function () {
            ...
            // $('#stripe_status').is(':checked') ? $('#stripe-credentials').removeClass('d-none') : $('#stripe-credentials').addClass('d-none');

            // $('#stripe_commission_status').is(':checked') ? $('#stripe-commission-credentials').removeClass('d-none') : $('#stripe-commission-credentials').addClass('d-none');

            // $('#stripe_commission_status').is(':checked') ? $('#stripe-commission-credentials').removeClass('d-none') : $('#stripe-commission-credentials').addClass('d-none');

            // console.log($('#stripe_commission_status').is(':checked'));
            // if($('#stripe_status').is(':checked')){ alert('aaa') }

            // $('#razorpay_status').is(':checked') ? $('#razorpay-credentials').removeClass('d-none') : $('#razorpay-credentials').addClass('d-none');
            // $('#razorpay_commission_status').is(':checked') ? $('#razorpay-commission-credentials').removeClass('d-none') : $('#razorpay-commission-credentials').addClass('d-none');
        ...
        $(document).ready(function() {
            ...
            $('body').on('click', '.edit-payment-method', function () {
                ...
                $('#modelLgHeading').html('@lang('app.edit') @lang('app.offlinePaymentMethod')');
