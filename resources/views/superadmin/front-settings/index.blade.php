                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane" id="faq-settings">
                                    <div class="d-flex justify-content-center justify-content-md-end mb-3">
                                        <a href="javascript:;" id="create-faq" class="btn btn-rounded btn-primary mb-1 mr-2"> <i class="fa fa-plus"></i> Create New </a>
                                    </div>
...
@push('footer-js')
    ...
    <script>
        ...
        $(document).on('click', '#verify-v3', function() {
            ...
            var url = url;
            $.ajaxModal('#captcha-detail-modal', url);
        });
    ...
    $(document).ready(function() {
        ...
        $('body').on('click', '.edit-note', function() {
            $('#modelHeading').html('@lang('app.createNew') @lang('menu.language')');
            $.ajaxModal('#application-modal', '{{ route('superadmin.editNote') }}');
        });

        $('body').on('click', '.edit-terms', function() {
            $('#modelHeading').html('@lang('app.createNew') @lang('menu.language')');
            $.ajaxModal('#application-modal', '{{ route('superadmin.editTerms') }}');
        });
        ...
        $(document).ready(function() {
            ...
            $('body').on('click', '#create-slider', function () {
                ...
                $('#modelLgHeading').html('@lang('app.createNew') @lang('menu.slider')');
                $.ajaxModal('#application-lg-modal', url);
            });
            ...
            $('body').on('click', '.edit-slider', function () {
                ...
                $('#modelLgHeading').html('@lang('app.edit') @lang('menu.slider')');
                $.ajaxModal('#application-lg-modal', url);
            });
