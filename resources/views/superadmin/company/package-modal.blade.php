   ...
   <div class="row">
      ...
      <div class="col-md-12">
         ...
         <div class="input-group form-group">
            <input type="text" class="form-control" name="companyNAme" id="companyNAme" value="{{ $currentPackage->company_name }}" value disabled="disabled">
         </div>
      </div>
      <div class="col-md-12">
         <div class="form-group" id="pack">
            ...
            <option value="{{ $Packages->id }}" @if($Packages->id == $currentPackage->package->id) selected @endif data-monthly-price='{{ $Packages->monthly_price }}' data-annual-price='{{ $Packages->annual_price }}'>{{ ucfirst($Packages->name) }} </option>
            @endforeach
            </select>
         </div>
      </div>
      ...
      <div class="col-md-6">
         ...
         <div class="input-group form-group">
            <input onkeypress="return isNumberKey(event)" type="number" class="form-control" name="amount" id="amount" min="0" value="{{$currentPackage->package->annual_price}}">
         </div>
      </div>
      <div class="col-md-6">
         <label for="payDate">@lang('app.pay') @lang('app.date')</label>
         <div class="input-group form-group">
            <input type="text" class="form-control" name="payDate" id="payDate" value="{{ \Carbon\Carbon::now()->format($settings->date_format) }}">
      ...
      <div class="col-md-6">
         ...
         <div class="input-group form-group">
            <input type="text" class="form-control" name="licenceExpireDate" id="licenceExpireDate" value="{{ \Carbon\Carbon::now()->add(1, 'year')->format($settings->date_format) }}" readonly>
         </div>
      </div>
      <div class="col-md-12">
