...
@section('content')
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header" id="modal-header">
                    <span class="caption-subject font-red-sunglo bold uppercase" id="modelHeading">@lang('app.changePackage')</span>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-info updatePackage"><i class="fa fa-check"></i>@lang('app.update')</button>
    ...
    <div class="modal fade bs-modal-lg in" id="company-detail-modal" role="dialog">
        <div class="modal-dialog modal-lg" id="modal-data-application">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">@lang('app.Company Details')</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                </div>
...
@push('footer-js')
    <script>
        // Show manage package modal from package-modal.blade.php
        $(document).on('click', '.package-update-button', function() {
        ...
        $('body').on('click', '.view-company', function() {
            ...
            url = url.replace(':id', id);
                $.ajaxModal('#company-detail-modal', url);
        });
