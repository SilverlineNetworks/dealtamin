...
<div class="modal-body">
    <section class="mt-3 mb-3">
        <form class="form-horizontal ajax-form" id="editForm" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <input type="file" id="image" name="image"
                                    accept=".png,.jpg,.jpeg" class="dropify" data-default-file="{{ $frontSlide->image_url }}"
                                />
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-md-12">
                <div class="form-group">
                    <button id="save-edit-form" type="button" class="btn btn-success">
...
<script>
    ...
    $('body').on('click', '#save-edit-form', function() {
        const form = $('#editForm');

        $.easyAjax({
            url: '{{route('superadmin.front-slider.update', $frontSlide->id)}}',
            container: '#editForm',
            type: "POST",
            file:true,
            redirect: true,
