...
class PageObserver
{
    ...
    public function updating(Page $page)
    {
        if ($page->isDirty('slug') || $page->isDirty('title')) {
            SearchLog::updateSearchEntry($page->getRawOriginal('slug'), 'Page', $page->getRawOriginal('title'), 'admin.pages.edit', ['modified' => ['searchable_id' => $page->slug, 'title' => $page->title]]);
        }
    }
